...
def main():
    print("\nExpected: False")
    print("Output: %s" % member_of_nth_fib_lists([1, 2], [3, 4], [5, 6]))

    print("\nExpected: True")
    print("Output: %s" % member_of_nth_fib_lists([1, 2], [3, 4], [1, 2, 3, 4, 3, 4, 1, 2, 3, 4]))

    print("\nExpected: True")
    print("Output: %s" % member_of_nth_fib_lists([7, 11], [2], [7, 11, 2, 2, 7, 11, 2]))

    print("\nExpected: False")
    print("Output: %s" % member_of_nth_fib_lists([7, 11], [2], [11, 7, 2, 2, 7]))
