...
# main
def main():
    exList1 = [ 94, 95, 95, 95, 90 ]
    exList2 = [ 60, 70, 80, 90, 100 ]
    exList3 = [ 96, 95.5, 93, 89, 92 ]

    print(exList1)
    print("Score:", slope_style_score(exList1))
    print(exList2)
    print("Score:", slope_style_score(exList2))
    print(exList3)
    print("Score:", slope_style_score(exList3))
