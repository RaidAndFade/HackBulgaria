...
class SqlManagerTests(unittest.TestCase):
    ...
    def test_register_two(self):
        sql_manager.register("Haker", "1512512")
        sql_manager.register("User", "iloveponies")
        users_count = sql_manager.cursor.execute('SELECT Count(*)  FROM clients;').fetchone()
        self.assertEqual(3, users_count[0])
    ...
    def test_login_SQL_injection(self):
        logged_user = sql_manager.login('\' OR 1 = 1 --\'', "green")
        self.assertFalse(logged_user)
